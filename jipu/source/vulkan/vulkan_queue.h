...
public:
    ...
    void submit(CommandBuffers commandBuffers) override;
    void submit(CommandBuffers commandBuffers, Swapchain* swapchain) override;
...
private:
    ...
    std::vector<SubmitInfo> gatherSubmitInfo(CommandBuffers commandBuffers);
