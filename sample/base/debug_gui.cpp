    ...
    // create pipeline
    {
        ...
        VertexStage vertexStage{};
        {
...

            {
                ...
                vertexShaderModuleDescriptor.code = reinterpret_cast<const char*>(vertexShaderSource.data());
                vertexShaderModuleDescriptor.codeSize = static_cast<uint32_t>(vertexShaderSource.size() * 4);
        ...
        FragmentStage fragmentStage{};
        {
...

            {
                ...
                fragmentShaderModuleDescriptor.code = reinterpret_cast<const char*>(fragmentShaderSource.data());
                fragmentShaderModuleDescriptor.codeSize = static_cast<uint32_t>(fragmentShaderSource.size() * 4);
...
void DebugGUI::updateImGuiBuffer()
{
...
void DebugGUI::drawImGui(RenderPassEncoder* renderPassEncoder)
{
    ImDrawData* imDrawData = ImGui::GetDrawData();
