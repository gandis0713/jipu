...
class SkinningSample : public Sample, public Im_Gui
{
public:
    SkinningSample() = delete;
    SkinningSample(const SampleDescriptor& descriptor);
    ~SkinningSample() override;
...
SkinningSample::SkinningSample(const SampleDescriptor& descriptor)
    : Sample(descriptor)
{
}

SkinningSample::~SkinningSample()
{
    clearImGui();
...
void SkinningSample::createCamera()
{
...
void SkinningSample::updateUniformBuffer()
{
...
void SkinningSample::updateImGui()
{
...
void SkinningSample::createDevier()
{
...
void SkinningSample::createPhysicalDevice()
{
...
void SkinningSample::createDevice()
{
...
void SkinningSample::createSurface()
{
...
void SkinningSample::createSwapchain()
{
...
void SkinningSample::createCommandBuffer()
{
...
void SkinningSample::createQueue()
{
...
void SkinningSample::createVertexBuffer()
{
...
void SkinningSample::createIndexBuffer()
{
    BufferDescriptor descriptor{};
...
void SkinningSample::createUniformBuffer()
{
    BufferDescriptor descriptor{};
...
void SkinningSample::createBindingGroupLayout()
{
...
void SkinningSample::createBindingGroup()
{
...
void SkinningSample::createRenderPipeline()
{
    ...
    std::unique_ptr<ShaderModule> vertexShaderModule = nullptr;
    {
        ...
        std::vector<char> vertexShaderSource = utils::readFile(m_appDir / "skinning.vert.spv", m_handle);
    ...
    {
        ShaderModuleDescriptor descriptor{};
        std::vector<char> fragmentShaderSource = utils::readFile(m_appDir / "skinning.frag.spv", m_handle);
...
void android_main(struct android_app* app)
{
    vkt::SampleDescriptor descriptor{
        { 1000, 2000, "Skinning", app },
        ""
    };

    vkt::SkinningSample sample(descriptor);
