...
GLESSample::GLESSample(const GLESSampleDescriptor& descriptor)
    : m_descriptor(descriptor)
    , m_runner(m_descriptor.fps)
{
}

GLESSample::~GLESSample()
{
    if (isRunning())
    {
        stop();
...
void GLESSample::pause()
{
    m_runner.pause();
}

void GLESSample::resume()
{
    m_runner.resume();
}

void GLESSample::stop()
{
    m_runner.stop();
}

bool GLESSample::isRunning() const
{
