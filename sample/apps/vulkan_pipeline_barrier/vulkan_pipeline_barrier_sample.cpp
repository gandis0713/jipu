...
std::vector<Stage> STAGE_PRESETS{
...
void VulkanPipelineBarrierSample::updateImGui()
{
    ...
    // set ui
    {
        ...
        ImGui::Text("Source Stage");
        ImGui::Separator();
        if (ImGui::RadioButton("TOP_OF_PIPE_BIT", m_stage.srcStageMask == VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT))
            m_stage.srcStageMask = VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT;
        else if (ImGui::RadioButton("DRAW_INDIRECT_BIT", m_stage.srcStageMask == VK_PIPELINE_STAGE_DRAW_INDIRECT_BIT))
            m_stage.srcStageMask = VK_PIPELINE_STAGE_DRAW_INDIRECT_BIT;
        else if (ImGui::RadioButton("VERTEX_INPUT_BIT", m_stage.srcStageMask == VK_PIPELINE_STAGE_VERTEX_INPUT_BIT))
            m_stage.srcStageMask = VK_PIPELINE_STAGE_VERTEX_INPUT_BIT;
        else if (ImGui::RadioButton("VERTEX_SHADER_BIT", m_stage.srcStageMask == VK_PIPELINE_STAGE_VERTEX_SHADER_BIT))
            m_stage.srcStageMask = VK_PIPELINE_STAGE_VERTEX_SHADER_BIT;
        else if (ImGui::RadioButton("TESSELLATION_CONTROL_SHADER_BIT", m_stage.srcStageMask == VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT))
            m_stage.srcStageMask = VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT;
        else if (ImGui::RadioButton("TESSELLATION_EVALUATION_SHADER_BIT", m_stage.srcStageMask == VK_PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BIT))
            m_stage.srcStageMask = VK_PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BIT;
        else if (ImGui::RadioButton("GEOMETRY_SHADER_BIT", m_stage.srcStageMask == VK_PIPELINE_STAGE_GEOMETRY_SHADER_BIT))
            m_stage.srcStageMask = VK_PIPELINE_STAGE_GEOMETRY_SHADER_BIT;
        else if (ImGui::RadioButton("FRAGMENT_SHADER_BIT", m_stage.srcStageMask == VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT))
            m_stage.srcStageMask = VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT;
        else if (ImGui::RadioButton("EARLY_FRAGMENT_TESTS_BIT", m_stage.srcStageMask == VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT))
            m_stage.srcStageMask = VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT;
        else if (ImGui::RadioButton("LATE_FRAGMENT_TESTS_BIT", m_stage.srcStageMask == VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT))
            m_stage.srcStageMask = VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT;
        else if (ImGui::RadioButton("COLOR_ATTACHMENT_OUTPUT_BIT", m_stage.srcStageMask == VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT))
            m_stage.srcStageMask = VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT;
        else if (ImGui::RadioButton("COMPUTE_SHADER_BIT", m_stage.srcStageMask == VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT))
            m_stage.srcStageMask = VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT;
        else if (ImGui::RadioButton("TRANSFER_BIT", m_stage.srcStageMask == VK_PIPELINE_STAGE_TRANSFER_BIT))
            m_stage.srcStageMask = VK_PIPELINE_STAGE_TRANSFER_BIT;
        else if (ImGui::RadioButton("BOTTOM_OF_PIPE_BIT", m_stage.srcStageMask == VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT))
            m_stage.srcStageMask = VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT;

        ImGui::Text("Destination Stage");
        ImGui::Separator();
        if (ImGui::RadioButton("TOP_OF_PIPE_BIT", m_stage.dstStageMask == VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT))
            m_stage.dstStageMask = VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT;
        else if (ImGui::RadioButton("DRAW_INDIRECT_BIT", m_stage.dstStageMask == VK_PIPELINE_STAGE_DRAW_INDIRECT_BIT))
            m_stage.dstStageMask = VK_PIPELINE_STAGE_DRAW_INDIRECT_BIT;
        else if (ImGui::RadioButton("VERTEX_INPUT_BIT", m_stage.dstStageMask == VK_PIPELINE_STAGE_VERTEX_INPUT_BIT))
            m_stage.dstStageMask = VK_PIPELINE_STAGE_VERTEX_INPUT_BIT;
        else if (ImGui::RadioButton("VERTEX_SHADER_BIT", m_stage.dstStageMask == VK_PIPELINE_STAGE_VERTEX_SHADER_BIT))
            m_stage.dstStageMask = VK_PIPELINE_STAGE_VERTEX_SHADER_BIT;
        else if (ImGui::RadioButton("TESSELLATION_CONTROL_SHADER_BIT", m_stage.dstStageMask == VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT))
            m_stage.dstStageMask = VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT;
        else if (ImGui::RadioButton("TESSELLATION_EVALUATION_SHADER_BIT", m_stage.dstStageMask == VK_PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BIT))
            m_stage.dstStageMask = VK_PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BIT;
        else if (ImGui::RadioButton("GEOMETRY_SHADER_BIT", m_stage.dstStageMask == VK_PIPELINE_STAGE_GEOMETRY_SHADER_BIT))
            m_stage.dstStageMask = VK_PIPELINE_STAGE_GEOMETRY_SHADER_BIT;
        else if (ImGui::RadioButton("FRAGMENT_SHADER_BIT", m_stage.dstStageMask == VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT))
            m_stage.dstStageMask = VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT;
        else if (ImGui::RadioButton("EARLY_FRAGMENT_TESTS_BIT", m_stage.dstStageMask == VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT))
            m_stage.dstStageMask = VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT;
        else if (ImGui::RadioButton("LATE_FRAGMENT_TESTS_BIT", m_stage.dstStageMask == VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT))
            m_stage.dstStageMask = VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT;
        else if (ImGui::RadioButton("COLOR_ATTACHMENT_OUTPUT_BIT", m_stage.dstStageMask == VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT))
            m_stage.dstStageMask = VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT;
        else if (ImGui::RadioButton("COMPUTE_SHADER_BIT", m_stage.dstStageMask == VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT))
            m_stage.dstStageMask = VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT;
        else if (ImGui::RadioButton("TRANSFER_BIT", m_stage.dstStageMask == VK_PIPELINE_STAGE_TRANSFER_BIT))
            m_stage.dstStageMask = VK_PIPELINE_STAGE_TRANSFER_BIT;
        else if (ImGui::RadioButton("BOTTOM_OF_PIPE_BIT", m_stage.dstStageMask == VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT))
            m_stage.dstStageMask = VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT;
...
void VulkanPipelineBarrierSample::createOffscreenRenderPipeline()
{
    ...
    vkdescriptor.renderPass = getOffscreenRenderPass(m_stage);
