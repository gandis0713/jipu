...
namespace vks 
{
                    ...
                    AllocationCallbacks* allocator)
  {
    ...
    appInfo.engineVersion = VK_MAKE_VERSION(VKS_VERSION_MAJOR, VKS_VERSION_MINOR, VKS_VERSION_PATCH);
    ...
    createInfo.ppEnabledExtensionNames = instance_extensions.empty() ? nullptr : instance_extensions.data();
